                ...
                <div class="portlet-body form">
                    <form role="form" class="form-horizontal" method="post" id="EditForm" action="/admin/cms/article/save">
                        <div class="form-body" style="padding-top:30px;">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">允许评论<span class="required" >*</span></label>
                                <div  class="col-md-8" >
...
@section('foot_script')
    ...
    <script>
        ...
        $(function(){
            ...
            ajaxSelectSimple('/admin/cms/catalog/getCatalogByParent/0','catalog_id_1','id','name','');
            ...
            $("#catalog_id_1").change(function(){
                ...
                if(catalog_id_1 != ''){
                    ajaxSelectSimple('/admin/cms/catalog/getCatalogByParent/'+catalog_id_1 ,'catalog_id_2','id','name','');
                }
            });
    ...
    <script>
        ...
        uploader.bind('FileUploaded',function(uploader,file,responseObject){
            var file = eval('('+responseObject.response+')');
            $("#upload_image").next('img').attr('src',file.pic_url).show();
            $("#logo").val(file.pic_url);
        });
