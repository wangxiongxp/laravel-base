            ...
            <form id="AddForm" method="post" role="form" class="form-horizontal">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" id="menu_parent" disabled="disabled" name="menu_parent">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="menu_text" name="menu_text" value="{{ $menu->menu_text}}" placeholder="" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">菜单Url<span class="required" >*</span></label>
                        <div class="col-md-6">
                            <input type="text" id="menu_url" name="menu_url" value="{{ $menu->menu_url}}" placeholder="" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">图标<span class="required" >*</span></label>
                        <div class="col-md-6">
                            <input type="text" id="menu_css" name="menu_css" value="{{ $menu->menu_css}}" placeholder="" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">排序<span class="required" >*</span></label>
                        <div class="col-md-6">
                            <input type="text" id="menu_sort" name="menu_sort" value="{{ $menu->menu_sort}}" placeholder="" class="form-control">
                        </div>
                    </div>
                </div>
            </form>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ajaxSelectSimple('/admin/menu/getFirstMenu','menu_parent','menu_id','menu_text','{{ $menu->menu_parent}}');
        var setting = {
            rules: {
                menu_parent: {
                    required: true
